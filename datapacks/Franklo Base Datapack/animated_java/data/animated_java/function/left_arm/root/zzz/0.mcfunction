...
function animated_java:left_arm/root/outdated_tellraw with storage aj:temp
data modify entity @s data.rigHash set value '34a9c7f83beb917e3532f1a9ad38956858bcea55d1140131d399700bed60d633'
