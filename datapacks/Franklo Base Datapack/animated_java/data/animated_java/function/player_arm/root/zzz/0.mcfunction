...
function animated_java:player_arm/root/outdated_tellraw with storage aj:temp
data modify entity @s data.rigHash set value 'be3803a267b4bd8323409f7109efcadfb1fca640fbbb4a85cf18b12a11387078'
