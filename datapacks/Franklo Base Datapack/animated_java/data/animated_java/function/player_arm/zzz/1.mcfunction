...
execute on vehicle on passengers if entity @s[tag=aj.player_arm.node.arm] run function animated_java:global/internal/gu/convert_uuid_array_to_string with entity @s
