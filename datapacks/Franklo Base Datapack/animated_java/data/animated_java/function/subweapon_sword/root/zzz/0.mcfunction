...
function animated_java:subweapon_sword/root/outdated_tellraw with storage aj:temp
data modify entity @s data.rigHash set value 'aed156fe4ae82b7f39338af2bfac76a6672ca0848c4ce785a95d61a0eaba1b82'
