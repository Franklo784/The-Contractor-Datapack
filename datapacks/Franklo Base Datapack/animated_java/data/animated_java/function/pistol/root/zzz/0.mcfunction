...
function animated_java:pistol/root/outdated_tellraw with storage aj:temp
data modify entity @s data.rigHash set value '8c1989ec7cf5ea5ebf470d4f4873eff6a5f493dad4a55bdd29dafe33aba16927'
