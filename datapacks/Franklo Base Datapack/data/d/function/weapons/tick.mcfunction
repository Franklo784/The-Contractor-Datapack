...
execute at @p if entity @p[nbt={SelectedItem:{components:{"minecraft:custom_data":{Arm:1b}}}},tag=ingame] unless entity @e[tag=arm_model] run function animated_java:player_arm/summon {args:1}
execute at @p if entity @p[tag=ingame] unless entity @p[nbt={SelectedItem:{components:{"minecraft:custom_data":{Arm:1b}}}}] run function animated_java:player_arm/remove/all
...
execute as @p[tag=sliding] at @s positioned ~ ~.7 ~ run tp @e[tag=arm_model] ^ ^ ^1.2 ~ ~
...
execute if entity @p[nbt={SelectedItem:{components:{"minecraft:custom_data":{MainWeapon:1b}}}}] unless entity @e[tag=wpn_interaction] run summon interaction ~ ~ ~ {Tags:["wpn_interaction"],height:8,width:8}
execute unless entity @p[nbt={SelectedItem:{components:{"minecraft:custom_data":{MainWeapon:1b}}}}] run kill @e[tag=wpn_interaction]
execute as @p at @s run tp @e[tag=wpn_interaction] ~ ~-3 ~

#> Energy Piercer (Pistol)

# Display

execute at @p if entity @p[nbt={SelectedItem:{components:{"minecraft:custom_data":{Pistol:1b}}}},tag=ingame] unless entity @e[tag=pistol_model] run function animated_java:pistol/summon {args:1}
execute at @p if entity @p[tag=ingame] unless entity @p[nbt={SelectedItem:{components:{"minecraft:custom_data":{Pistol:1b}}}}] run function animated_java:pistol/remove/all
execute unless entity @p[tag=ingame] run function animated_java:pistol/remove/all
execute as @p[tag=!sliding] at @s positioned ~ ~1.2 ~ run tp @e[tag=pistol_model] ^ ^ ^.8 ~ ~
...
execute at @p[nbt={SelectedItem:{components:{"minecraft:custom_data":{Pistol:1b}}}}] if score @p coin_refill matches 79 run playsound weapon.pistol.coin.refill player @p ~ ~ ~ 1 1.5 1

execute as @e[tag=wpn_interaction] on attacker if entity @s[nbt={SelectedItem:{components:{"minecraft:custom_data":{Pistol:1b}}}}] at @s unless score .pistol_alt wpn_cooldown matches 1.. if score @s coin_count matches 1.. run playsound weapon.pistol.coin.throw player @a ~ ~ ~ .75 0.8 1
execute as @e[tag=wpn_interaction] on attacker if entity @s[nbt={SelectedItem:{components:{"minecraft:custom_data":{Pistol:1b}}}},tag=!sliding] at @p unless score .pistol_alt wpn_cooldown matches 1.. if score @s coin_count matches 1.. run summon marker ~ ~1.5 ~ {Tags:["projectile","player_projectile","coin"]}
execute as @e[tag=wpn_interaction] on attacker if entity @s[nbt={SelectedItem:{components:{"minecraft:custom_data":{Pistol:1b}}}},tag=sliding] at @p unless score .pistol_alt wpn_cooldown matches 1.. if score @s coin_count matches 1.. run summon marker ~ ~.8 ~ {Tags:["projectile","player_projectile","coin"]}
execute as @e[tag=wpn_interaction] on attacker if entity @s[nbt={SelectedItem:{components:{"minecraft:custom_data":{Pistol:1b}}}}] unless score .pistol_alt wpn_cooldown matches 1.. if score @s coin_count matches 1.. run scoreboard players remove @p coin_count 1
execute as @e[tag=wpn_interaction] on attacker if entity @s[nbt={SelectedItem:{components:{"minecraft:custom_data":{Pistol:1b}}}}] unless score .pistol_alt wpn_cooldown matches 1.. if score @s coin_count matches 1.. run scoreboard players set .pistol_alt wpn_cooldown 3
...
execute at @p if entity @p[nbt={SelectedItem:{components:{"minecraft:custom_data":{Machinegun:1b}}}},tag=ingame] unless entity @e[tag=machinegun_model] run function animated_java:machinegun/summon {args:1}
execute at @p if entity @p[tag=ingame] unless entity @p[nbt={SelectedItem:{components:{"minecraft:custom_data":{Machinegun:1b}}}}] run function animated_java:machinegun/remove/all
execute unless entity @p[tag=ingame] run function animated_java:machinegun/remove/all
execute as @p[tag=!sliding] at @s positioned ~ ~1.2 ~ run tp @e[tag=machinegun_model] ^ ^ ^.8 ~ ~
...
execute as @e[tag=wpn_interaction] on target if entity @s[nbt={SelectedItem:{components:{"minecraft:custom_data":{Machinegun:1b}}}}] as @e[tag=machinegun_model] unless score .machinegun wpn_cooldown matches 1.. unless score .machinegun_alt wpn_cooldown matches 1.. run function animated_java:machinegun/animations/shoot/play
execute as @e[tag=wpn_interaction] on target if entity @s[nbt={SelectedItem:{components:{"minecraft:custom_data":{Machinegun:1b}}}}] at @s unless score .machinegun wpn_cooldown matches 1.. unless score .machinegun_alt wpn_cooldown matches 1.. run playsound weapon.machinegun.ready player @s ~ ~ ~ .85 1 1
execute as @e[tag=wpn_interaction] on target if entity @s[nbt={SelectedItem:{components:{"minecraft:custom_data":{Machinegun:1b}}}}] unless score .machinegun wpn_cooldown matches 1.. unless score .machinegun_alt wpn_cooldown matches 1.. run scoreboard players set .machinegun wpn_cooldown 54

execute if score .machinegun wpn_cooldown matches 1.. run scoreboard players remove .machinegun wpn_cooldown 1
execute if score .machinegun wpn_cooldown matches 1.. unless entity @p[nbt={SelectedItem:{components:{"minecraft:custom_data":{Machinegun:1b}}}}] run scoreboard players set .machinegun wpn_cooldown 3
...
execute as @e[tag=machinegun_bullet] at @s unless entity @e[tag=machinegun_bullet_display,distance=..1,limit=1,sort=nearest] run summon item_display ~ ~ ~ {Tags:["machinegun_bullet_display"],item:{id:"minecraft:stick",count:1,components:{"minecraft:custom_model_data":{floats:[5]}}},Glowing:1b,glow_color_override:65535}
...
execute as @e[tag=machinegun_bullet] at @s as @e[tag=enemy,dx=0,scores={machinegun_invul=0}] at @s positioned ~-.99 ~-.99 ~-.99 if entity @s[dx=0] run scoreboard players remove @s enemy_health 30
execute as @e[tag=machinegun_bullet] at @s as @e[tag=enemy,dx=0,scores={machinegun_invul=0}] at @s positioned ~-.99 ~-.99 ~-.99 if entity @s[dx=0] run damage @s 1
...
execute as @e[tag=wpn_interaction] on attacker if entity @s[nbt={SelectedItem:{components:{"minecraft:custom_data":{Machinegun:1b}}}}] as @e[tag=machinegun_model] unless score .machinegun_alt wpn_cooldown matches 1.. unless score .machinegun wpn_cooldown matches 1.. run function animated_java:machinegun/animations/alt_fire/play
execute as @e[tag=wpn_interaction] on attacker if entity @s[nbt={SelectedItem:{components:{"minecraft:custom_data":{Machinegun:1b}}}}] at @s unless score .machinegun_alt wpn_cooldown matches 1.. unless score .machinegun wpn_cooldown matches 1.. run playsound weapon.machinegun.ready player @s ~ ~ ~ .85 2 1
execute as @e[tag=wpn_interaction] on attacker if entity @s[nbt={SelectedItem:{components:{"minecraft:custom_data":{Machinegun:1b}}}}] unless score .machinegun_alt wpn_cooldown matches 1.. unless score .machinegun wpn_cooldown matches 1.. run scoreboard players set .machinegun_alt wpn_cooldown 40
...
execute if score .machinegun_alt wpn_cooldown matches 1.. unless entity @p[nbt={SelectedItem:{components:{"minecraft:custom_data":{Machinegun:1b}}}}] run scoreboard players reset .machinegun_alt wpn_cooldown
...
execute at @e[tag=machinegun_grenade_explode] run scoreboard players remove @e[tag=enemy,distance=1.1..3.5,scores={machinegun_alt_invul=0}] enemy_health 125
execute at @e[tag=machinegun_grenade_explode] run scoreboard players remove @e[tag=enemy,distance=..1,scores={machinegun_alt_invul=0}] enemy_health 250
execute at @e[tag=machinegun_grenade_explode] as @e[tag=enemy,distance=..3.5,scores={machinegun_alt_invul=0}] run damage @s 1
...
execute at @p if entity @p[nbt={SelectedItem:{components:{"minecraft:custom_data":{Shotgun:1b}}}},tag=ingame] unless entity @e[tag=shotgun_model] run function animated_java:shotgun/summon {args:1}
execute at @p if entity @p[tag=ingame] unless entity @p[nbt={SelectedItem:{components:{"minecraft:custom_data":{Shotgun:1b}}}}] run function animated_java:shotgun/remove/all
execute unless entity @p[tag=ingame] run function animated_java:shotgun/remove/all
...
execute at @p[nbt={SelectedItem:{components:{"minecraft:custom_data":{Shotgun:1b}}}}] if score @p shotgun_ammo matches 24 run playsound weapon.shotgun.recharge player @a ~ ~ ~ .35 2 1
execute at @p[nbt={SelectedItem:{components:{"minecraft:custom_data":{Shotgun:1b}}}}] if score @p shotgun_ammo matches 49 run playsound weapon.shotgun.recharge player @a ~ ~ ~ .35 2 1
execute at @p[nbt={SelectedItem:{components:{"minecraft:custom_data":{Shotgun:1b}}}}] if score @p shotgun_ammo matches 74 run playsound weapon.shotgun.recharge player @a ~ ~ ~ .35 2 1
execute at @p[nbt={SelectedItem:{components:{"minecraft:custom_data":{Shotgun:1b}}}}] if score @p shotgun_ammo matches 99 run playsound weapon.shotgun.recharge player @a ~ ~ ~ .35 2 1

execute as @e[tag=wpn_interaction] on target if entity @s[nbt={SelectedItem:{components:{"minecraft:custom_data":{Shotgun:1b}}}}] if score @s shotgun_ammo matches 25.. as @e[tag=shotgun_model] unless score .shotgun wpn_cooldown matches 1.. run function animated_java:shotgun/animations/shoot/play
execute as @e[tag=wpn_interaction] on target if entity @s[nbt={SelectedItem:{components:{"minecraft:custom_data":{Shotgun:1b}}}}] at @s unless score .shotgun wpn_cooldown matches 1.. if score @s shotgun_ammo matches 25.. run playsound weapon.shotgun.fire player @s ~ ~ ~ .35 2 1
execute as @e[tag=wpn_interaction] on target if entity @s[nbt={SelectedItem:{components:{"minecraft:custom_data":{Shotgun:1b}}}},tag=!sliding] at @s unless score .shotgun wpn_cooldown matches 1.. if score @s shotgun_ammo matches 25.. run function d:weapons/shotgun_bullets {offset:"1.5"}
execute as @e[tag=wpn_interaction] on target if entity @s[nbt={SelectedItem:{components:{"minecraft:custom_data":{Shotgun:1b}}}},tag=sliding] at @s unless score .shotgun wpn_cooldown matches 1.. if score @s shotgun_ammo matches 25.. run function d:weapons/shotgun_bullets {offset:"0.8"}
execute as @e[tag=wpn_interaction] on target if entity @s[nbt={SelectedItem:{components:{"minecraft:custom_data":{Shotgun:1b}}}}] unless score .shotgun wpn_cooldown matches 1.. if score @s shotgun_ammo matches 25.. run function d:weapons/shotgun_cooldown
...
execute as @p[tag=sliding] at @s run tp @e[tag=shotgun_projectile,scores={projectile_lifetime=1..2}] ~ ~.8 ~ ~ ~

execute as @e[tag=shotgun_projectile] at @s unless entity @e[tag=shotgun_projectile_display,distance=..0.75,limit=1,sort=nearest] run summon item_display ~ ~ ~ {Tags:["shotgun_projectile_display"],item:{id:"minecraft:stick",count:1,components:{"minecraft:custom_model_data":{floats:[5]}}},Glowing:1b,glow_color_override:65535}
execute as @e[tag=shotgun_projectile_display] at @s unless entity @e[tag=shotgun_projectile,distance=..0.75,limit=1,sort=nearest] run kill @s

execute as @e[tag=shotgun_projectile] at @s run tp @e[tag=shotgun_projectile_display,distance=..0.75,limit=1,sort=nearest] ~ ~ ~ ~ ~
...
execute as @e[tag=shotgun_projectile] at @s as @e[tag=enemy,dx=0,scores={shotgun_invul=0}] at @s positioned ~-.99 ~-.99 ~-.99 if entity @s[dx=0] run scoreboard players remove @s enemy_health 45
execute as @e[tag=shotgun_projectile] at @s as @e[tag=enemy,dx=0,scores={shotgun_invul=0}] at @s positioned ~-.99 ~-.99 ~-.99 if entity @s[dx=0] run damage @s 1
...
kill @e[tag=shotgun_projectile,scores={projectile_lifetime=25..}]
...
execute at @p if entity @p[tag=ingame,scores={sub_weapon=0}] unless entity @e[tag=arm_model_left] run function animated_java:left_arm/summon {args:1}
execute at @p if entity @p[tag=ingame] unless entity @p[scores={sub_weapon=0}] run function animated_java:left_arm/remove/all
...
execute as @p[tag=sliding] at @s positioned ~ ~.7 ~ run tp @e[tag=arm_model_left] ^ ^ ^1.2 ~ ~
...
execute at @p if entity @p[tag=ingame,scores={sub_weapon=1}] unless entity @e[tag=sword_model] run function animated_java:subweapon_sword/summon {args:1}
execute at @p if entity @p[tag=ingame] unless entity @p[scores={sub_weapon=1}] run function animated_java:subweapon_sword/remove/all
execute unless entity @p[tag=ingame] run function animated_java:subweapon_sword/remove/all

execute as @p[tag=!sliding] at @s positioned ~ ~1.2 ~ run tp @e[tag=sword_model] ^ ^ ^.8 ~ ~
execute as @p[tag=sliding] at @s positioned ~ ~.5 ~ run tp @e[tag=sword_model] ^ ^ ^1.2 ~ ~
...
execute as @p[scores={sword_cooldown=5},tag=!sliding] at @s positioned ~ ~1.2 ~ run particle sweep_attack ^ ^ ^2.25 .3 .1 .3 0 35 force
execute as @p[scores={sword_cooldown=5},tag=sliding] at @s positioned ~ ~.6 ~ run particle sweep_attack ^ ^ ^4 .3 .1 .3 0 35 force

execute as @p[scores={sword_cooldown=5},tag=!sliding] at @s positioned ~ ~1.2 ~ positioned ^ ^ ^1.5 as @e[tag=enemy,distance=..2.3,scores={sword_invul=0}] run damage @s 1
execute as @p[scores={sword_cooldown=5},tag=!sliding] at @s positioned ~ ~1.2 ~ positioned ^ ^ ^1.5 as @e[tag=enemy,distance=..2.3,scores={sword_invul=0}] run scoreboard players remove @s enemy_health 100
execute as @p[scores={sword_cooldown=5},tag=!sliding] at @s positioned ~ ~1.2 ~ positioned ^ ^ ^1.5 as @e[tag=enemy,distance=..2.3,scores={sword_invul=0}] run scoreboard players set @s sword_invul 10

execute as @p[scores={sword_cooldown=5},tag=sliding] at @s positioned ~ ~.6 ~ positioned ^ ^ ^2.5 as @e[tag=enemy,distance=..2.3,scores={sword_invul=0}] run damage @s 1
execute as @p[scores={sword_cooldown=5},tag=sliding] at @s positioned ~ ~.6 ~ positioned ^ ^ ^2.5 as @e[tag=enemy,distance=..2.3,scores={sword_invul=0}] run scoreboard players remove @s enemy_health 100
execute as @p[scores={sword_cooldown=5},tag=sliding] at @s positioned ~ ~.6 ~ positioned ^ ^ ^2.5 as @e[tag=enemy,distance=..2.3,scores={sword_invul=0}] run scoreboard players set @s sword_invul 10

# Parrying

execute as @p[scores={sword_cooldown=5},tag=!sliding] at @s positioned ~ ~1.2 ~ run function d:weapons/raycast/parry
...
execute as @e[tag=parried] at @s as @e[tag=enemy,dx=0,scores={parry_invul=0}] at @s positioned ~-.99 ~-.99 ~-.99 if entity @s[dx=0] run scoreboard players remove @s enemy_health 500
execute as @e[tag=parried] at @s as @e[tag=enemy,dx=0,scores={parry_invul=0}] at @s positioned ~-.99 ~-.99 ~-.99 if entity @s[dx=0] run damage @s 1
execute as @e[tag=parried] at @s as @e[tag=enemy,dx=0,scores={parry_invul=0}] at @s positioned ~-.99 ~-.99 ~-.99 if entity @s[dx=0] run scoreboard players set @s parry_invul 20
execute as @e[tag=parried] at @s as @e[tag=enemy,dx=0] positioned ~-.99 ~-.99 ~-.99 if entity @s[dx=0] at @n[tag=parried] run summon marker ~ ~ ~ {Tags:["player_projectile","parry_explode"]}
...
execute at @e[tag=parry_explode] run scoreboard players remove @e[tag=enemy,distance=1.1..2,scores={machinegun_alt_invul=0}] enemy_health 250
execute at @e[tag=parry_explode] run scoreboard players remove @e[tag=enemy,distance=..1,scores={machinegun_alt_invul=0}] enemy_health 500
execute at @e[tag=parry_explode] as @e[tag=enemy,distance=..2,scores={machinegun_alt_invul=0}] run damage @s 1
execute at @e[tag=parry_explode] run scoreboard players set @e[tag=enemy,distance=..2,scores={machinegun_alt_invul=0}] machinegun_alt_invul 30
...
execute as @e[tag=cursed_soul_projectile,tag=parried] at @s unless entity @e[tag=cursed] run tp @s ^ ^ ^0.85
